...
from model.TGCRN import TGCRN as Network
...
args.add_argument('--gcn_layer', default=config['model']['gcn_layer'], type=int)
args.add_argument('--time_layer', default=config['model']['time_layer'], type=int)
args.add_argument('--alpha', default=config['model']['alpha'], type=float)
args.add_argument('--droprate', default=config['model']['droprate'], type=float)
args.add_argument('--time_drop', default=config['model']['time_drop'], type=float)
